...
<nav class="navbar navbar-inverse navbar-expand-lg" role="navigation">
  <a class="navbar-brand" href="#">兴趣班自选系统</a>
  <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbar-collapse-01"></button>
  <div class="collapse navbar-collapse" id="navbar-collapse-01">
  <ul class="nav navbar-nav mr-auto">
			<li><a href="/StudentInfo/CoursePlanHandler/addquery/1"><strong>添加教学兴趣班</strong></a>
			
			<li><a
				href="/StudentInfo/TeacherHandler/managecou/${sessionScope.tid }/1"><strong>管理教学兴趣班</strong></a>
